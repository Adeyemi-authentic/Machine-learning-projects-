...
def predict_parkinsons(features):
    ...
    model = joblib.load('parkinson-model2.pkl')
...
def home_page():
    ...
    if st.button('Predict'):
        ...
        features = [fo_hz, fhi_hz, flo_hz, jitter_percent, rap, ppq, jitter_ddp, apq, nhr, hnr, rpde, dfa, spread2, d2,
                    ppe]
...
def main():
    ...
    page_selection = st.sidebar.radio("Go to", ["Home", "Power-Bi Dashboard"])
...
if __name__ == '__main__':
    ...
    if st.button("Predict"):
        result = prediction(fo_hz, fhi_hz, flo_hz, jitter_percent, rap, ppq, jitter_ddp, apq, nhr, hnr, rpde, dfa,
                            spread2, d2, ppe)
